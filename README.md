...
- Veritabanındaki boykotlu sanatçıları/markaları tespit eder.
- Tek tıkla boykotlu şarkıları listenizden temizler.
- Vatansever sanatçıları öne çıkarır.
...
3. `npm run dev` ile yerelde çalıştırın.
